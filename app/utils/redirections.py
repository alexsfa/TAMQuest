...
'''
The redirect_to_respond_page function redirects to a
questionnaire's response page.
...
'''
The redirect_to_respond_page function redirects to
a questionnaire's results page.
...
'''
The redirect_to_edit_page function redirects
to a response's edit page.
...
'''
The redirect_to_view_page function sets the current_respond_id
and redirects to response view page
'''
