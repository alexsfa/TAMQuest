class Profiles:
    ...
    """
    The get_all_profiles function returns all the profiles
    from database's profiles table
    ...
    """
    The get_profile_by_id function returns the profile that its user_id
    matches the parameter user_id (for user)
    """
    ...
    """
    The create_profile function inserts a new row on
    the database's profiles table (for users)
    """
    def create_profile(
        self,
        user_id: str,
    ...
    """
    The update_profile function updates the profile
    that its id matches the profile_id (for admins)
    """
    ...
    """
    The delete_profile_by_id function deletes the profile
    that its id matches the profile_id (for users)
    """
