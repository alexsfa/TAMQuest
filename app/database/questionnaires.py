...
class Questionnaires:
    ...
    """
    The get_questionnaire_by_id function returns a questionnaire by its own id (for users)
    """
    def get_questionnaire_by_id(self, questionnaire_id: str):
        try:
            return self.supabase_client.table("questionnaires").select("id, title, details, created_at").eq("id", questionnaire_id).execute()
        except Exception as e:
    ...
    """
    The create_questionnaire function inserts a new questionnaire in the database's questionnaire table (for admins)
    """
    ...
    """
    The delete_questionnaire_by_id function deletes a questionnaire from the database's questionnaire table (for admins)
    """
    def delete_questionnaire_by_id(self, questionnaire_id: str):
        try:
            return self.supabase_client.table("questionnaires").delete().eq("id", questionnaire_id).execute()
        except Exception as e:
